...
class ConvertONNX2MM(Convert2TensorRTWithMaxBatchSizeSearch):
    ...
    def _run(
        ...
        """
        LOGGER.info("ONNX to MagicMind conversion started")

        # 修改为检查 MagicMind 是否存在
        ...
        def get_args(max_batch_size=None):
            ...
            kwargs = {
                "onnx": input_model_path.relative_to(workspace.path).as_posix(),
                "magicmind_model": converted_model_path.relative_to(workspace.path).as_posix(),
        ...
        with ExecutionContext(
            ...
            from model_navigator.commands.convert.converters.magicmind import onnx2mm_script
            context.execute_python_script(
                onnx2mm_script.__file__,
                onnx2mm_script.convert,
                get_args(),
